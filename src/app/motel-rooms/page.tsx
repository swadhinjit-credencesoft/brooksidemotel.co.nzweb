...
export const metadata: Metadata = {
  ...
  description:
    "Brand-new, ground-floor motel rooms in Rolleston with luxury bedding, Fibre Wi-Fi, Smart TV and free parking. Six room types including accessible and interconnected options.",
};
  ...
  return (
    <>
      <PageHero
        ...
        sub="Brand-new, ground-floor comfort with luxury bedding, high-speed Fibre Wi-Fi, and quiet surroundings in Rolleston."
      />
