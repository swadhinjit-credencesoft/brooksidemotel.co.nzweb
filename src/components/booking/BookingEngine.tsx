...
const STAAH_NAME_TO_SLUG: Record<string, string> = {
  ...
  "BROOKSIDE RESIDENCE": "brookside-residence",
  "BROOKSIDE RESIDENCE - 4 BEDROOM": "brookside-residence",
};
    ...
    <div className="be-wrap">
      ...
      <div className="be-brand">
        <a href="/" className="be-brand-link">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img className="be-brand-logo" src="/logos/logo-pine.png" alt="Brookside Motel" width={340} height={80} />
