...
export default function ResidenceSearchBar() {
  ...
  const submit = (e: React.FormEvent) => {
    ...
    window.location.href = residenceBookPageUrl({
      checkIn: ci,
      checkOut: co,
  ...
  return (
    <div className="search" id="search">
      <div className="wrap">
        ...
        >
          <div className="sf">
            <label htmlFor="res-sw-checkin">Check-in date</label>
            <div className="val">
          ...
          <div className="sf">
            <label htmlFor="res-sw-checkout">Check-out date</label>
            <div className="val">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden="true">
                <rect x="3" y="4" width="18" height="18" rx="2" />
                <path d="M16 2v4M8 2v4M3 10h18" />
          ...
          <div className="sf sw-guests">
            <label htmlFor="res-sw-adults">Guests</label>
            <div className="val">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden="true">
